    ...
    <section ref={containerRef} className="relative min-h-screen flex items-center overflow-hidden bg-[#1a1a1a]">
      ...
      <div className="container mx-auto px-4 relative z-20 pt-32 pb-20">
        ...
        >
          ...
          <motion.h1
            className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] mb-8 font-[var(--font-heading)]"
          ...
          >
            ...
            >
              Redefining Land Investment
            </motion.span>
            <br />
            <motion.span
              className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#C5A065] via-[#E5C085] to-[#C5A065]"
              animate={{
          ...
          >
            We bring clarity to land investments through expert advisory, market insights, and transparent deal structuring.
          </motion.p>
