...
const particles = [
  { left: 12, top: 15, duration: 3.2, delay: 0.4 },
  { left: 75, top: 22, duration: 4.1, delay: 1.6 },
  { left: 28, top: 68, duration: 3.7, delay: 0.9 },
  { left: 85, top: 45, duration: 4.4, delay: 2.2 },
  { left: 48, top: 32, duration: 3.5, delay: 1.1 },
  { left: 62, top: 78, duration: 4.0, delay: 2.7 },
  { left: 18, top: 52, duration: 3.3, delay: 0.6 },
  { left: 88, top: 38, duration: 4.2, delay: 1.8 },
  { left: 35, top: 85, duration: 3.9, delay: 2.4 },
  { left: 72, top: 58, duration: 4.3, delay: 0.3 },
]
