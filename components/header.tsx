      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between py-4 md:py-5">
            ...
            <button
              className="md:hidden p-3 transition-colors z-50 text-white min-w-[48px] min-h-[48px] flex items-center justify-center"
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            ...
            <button
              onClick={() => setMobileMenuOpen(false)}
              className="p-3 text-white/80 hover:text-[#C5A065] transition-colors min-w-[48px] min-h-[48px] flex items-center justify-center"
