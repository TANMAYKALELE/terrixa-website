    ...
    <section className="py-16 md:py-24 bg-[#111111]">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12"
        >
          {services.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:bg-white/[0.08]"
              >
