            ...
            <MaskText delay={0.2}>
              <div className="space-y-4">
                <p className="text-white/90 mb-6">
                  Whether you are evaluating land, plotting, residential purchases, or commercial leases, Terrixa Realty brings the clarity and discipline required to move forward with certainty.
                </p>
