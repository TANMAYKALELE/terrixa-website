        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a1a1a] mb-6 font-[var(--font-heading)]">
              Premium Lifestyle & Steady Returns
            </h2>

            <p className="text-[#1a1a1a]/70 text-lg mb-8 leading-relaxed">
              An established hill station offering premium plots with immediate lifestyle benefits and consistent investment returns.
            </p>
