...
const socials = [
  { icon: Facebook, href: "https://facebook.com/terrixarealty", label: "Facebook" },
  { icon: Twitter, href: "https://twitter.com/terrixarealty", label: "Twitter" },
  { icon: Linkedin, href: "https://linkedin.com/company/terrixarealty", label: "LinkedIn" },
  { icon: Instagram, href: "https://instagram.com/terrixarealty", label: "Instagram" },
]
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 text-white/50 hover:text-[#C5A065] transition-colors"
                    >
